...
importScripts("source-bsp-struct.js");

// There's only one type of message that this file can receive: Load a BSP file.
onmessage = function(msg) {
    Object.create(SourceBsp).load(msg.data, function() {
        close(); // Worker is done running, close it down
    });
};
